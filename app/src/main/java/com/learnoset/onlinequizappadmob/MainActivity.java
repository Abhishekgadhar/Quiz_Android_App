...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://quizappadmob-890d6-default-rtdb.firebaseio.com/");

        // to  show interstitial ad
        final AdRequest adRequest = new AdRequest.Builder().build(); //  making ad request

        // load requested ad and show. Replace Test Ad Unit Id with your original
        ...
        final InstructionsDialog instructionsDialog = new InstructionsDialog(MainActivity.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot questions : snapshot.child("questions").getChildren()) {
                    ...
                    int  getAnswer = Integer.parseInt(questions.child("answer").getValue(String.class)); // im using String here to database value must be in String form
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOption != 0) {
                    ...
                    if (selectedOption == questionsLists.get(currentQuestionPosition).getAnswer()) {
                        Toast.makeText(MainActivity.this, " Correct answer  " , Toast.LENGTH_SHORT).show();
                        // User's answer is correct
                        // You can add any specific logic here for correct answers if needed.
                    } else {
                        // User's answer is incorrect
                        // You can display the correct answer to the user.
                        int correctAnswer = questionsLists.get(currentQuestionPosition).getAnswer();
                        Toast.makeText(MainActivity.this, "Incorrect. Correct answer is option " + correctAnswer, Toast.LENGTH_SHORT).show();
                    }
